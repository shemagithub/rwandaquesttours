...
export function NotificationsForm() {
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      communication_emails: n.communication_emails ?? false,
      social_emails: n.social_emails ?? true,
      marketing_emails: n.marketing_emails ?? false,
      security_emails: n.security_emails ?? true,
    })
  }, [data, form])
    ...
    <Form {...form}>
      <form
        onSubmit={form.handleSubmit(async (v) => {
          setSaving(true)
          try {
            await api.patch('/api/admin-settings', { notifications: v })
